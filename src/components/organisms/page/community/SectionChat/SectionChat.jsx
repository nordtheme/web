    ...
    <Content centered decorated>
      <Grid>
        <ChatCard logoColor="#7b16ff" logoComponent={Spectrum} title="Spectrum" url={links.community.spectrum.url}>
          A simple, powerful real-time chat platform to build, grow, manage and measure any kind of online communities by providing a modern, scaling and easy
          to use cross-device app.
        </ChatCard>
        <ChatCard logoColor="#4c8eff" logoComponent={Keybase} title="Keybase" url={links.community.keybase.url}>
          Keybase is a open source security platform powered by public-key cryptography providing end-to-end encrypted chats, file shares, team tools and many
          more features across all devices.
        </ChatCard>
        <ChatCard logoColor="#36c5f0" logoComponent={Slack} title="Slack">
          Slack is is where work flows &mdash; a cloud-based collaboration hub for communities that provides integrations, tools and services to keep teams
          connected and allows to easily store and share information, discussions and important documents in one searchable place to get things done.
        </ChatCard>
        <ChatCard logoColor="#7289DA" logoComponent={Discord} title="Discord">
          ...
          <Link href="https://discordapp.com/open-source">open source software development</Link> that serves as a modern, crystal clear and secure
          communication channel across all devices.
        </ChatCard>
      </Grid>
    </Content>
    <WaveDivider />

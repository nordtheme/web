...
/**
 * The component that represents the editor details section for the landing page of the "Nord Atom Syntax" port project.
 * @since 0.19.0
 */
  ...
  <Section id={SECTION_ID} variant="secondary">
    <Content centered>
      ...
      <FeatureDuo columnRatio={[2, 1]}>
        <Visualization>
          <Video dropShadow loop poster={assets.videoPosters["editor-text-selection.mp4.png"]} rounded sources={[assets.videos["editor-text-selection.mp4"]]}>
      ...
      <FeatureDuo columnRatio={[1, 2]}>
        ...
        <Visualization>
          <Video dropShadow loop poster={assets.videoPosters["editor-search-marker.mp4.png"]} rounded sources={[assets.videos["editor-search-marker.mp4"]]}>
            <span>Code selection in the editor.</span>
          </Video>
        </Visualization>
      </FeatureDuo>

...
/**
 * The component that represents the hero section for the landing page of the "Nord Konsole" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-konsole");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Konsole.
        </P>
      </Content>
      <WaveFooter />
    </Section>

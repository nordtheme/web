...
/**
 * The component that represents the hero section for the landing page of the "Nord PuTTY" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-putty");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord PuTTY.
        </P>
      </Content>
      <WaveFooter />
    </Section>

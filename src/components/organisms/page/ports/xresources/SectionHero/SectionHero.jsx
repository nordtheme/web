...
/**
 * The component that represents the hero section for the landing page of the "Nord Xresources" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-xresources");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Xresources.
        </P>
      </Content>
      <WaveFooter />
    </Section>

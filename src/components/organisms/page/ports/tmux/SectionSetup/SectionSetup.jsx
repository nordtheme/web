      ...
      <Content centered decorated>
        <FeatureDuo verticalOnly>
          <Text verticalOnly>
            ...
            <Subline>
              Install Nord with your favorite plugin manager like <Link href="https://github.com/tmux-plugins/tpm">tpm</Link> within a few lines of code and
              automatic updates or simply set it up manually.
            </Subline>
            <Actions>
          ...
          <Visualization>
            ...
            >
              <span>
                Plugin setup and <Link href="https://github.com/tmux-plugins/tpm">tpm</Link> plugin manager initialization.
              </span>
            </Image>
          </Visualization>
        </FeatureDuo>

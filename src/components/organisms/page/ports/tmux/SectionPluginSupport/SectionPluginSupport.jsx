    ...
    <Content centered>
      <FeatureDuo columnRatio={[1, 2]}>
        <Text>
          ...
          <Subline>The theme supports many popular plugins for a fluid and unobtrusive user interface transition.</Subline>
        </Text>
        <Visualization>
          <Image
          ...
          >
            <span>
              UI support for the <Link href="https://github.com/tmux-plugins/tmux-prefix-highlight">tmux-prefix-highlight</Link> plugin.
            </span>
          </Image>
        </Visualization>
      </FeatureDuo>

...
import { ROUTE_PORTS_ATOM_SYNTAX, ROUTE_DOCS_PORTS_ATOM_UI, ROUTE_DOCS_PORTS_ATOM_UI_INSTALLATION, ROUTE_PORTS_ATOM_UI } from "config/routes/mappings";
...
const SectionHero = ({ assets }) => {
  ...
  const { gitHubRepositoryUrl, projectUrl } = portMetadata.find((port) => port.name === "atom-ui");
      ...
      <Content centered decorated>
        <FeatureDuo verticalOnly>
          <Text verticalOnly>
            ...
            <Subline>
              Designed for a optimized fluent and clear workflow matching the <Link to={ROUTE_PORTS_ATOM_SYNTAX}>Nord Atom Syntax</Link> theme.
            </Subline>
            <Actions>

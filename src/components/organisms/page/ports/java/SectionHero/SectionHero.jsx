...
/**
 * The component that represents the hero section for the landing page of the "Nord Java" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-java");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Java.
        </P>
      </Content>
      <WaveFooter />
    </Section>

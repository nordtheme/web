    ...
    <Content centered>
      <FeatureDuo columnRatio={[1, 2]}>
        <Text>
          ...
          <Subline>
            Popular and common code editor features like search result marker and bracket matching are designed to get
            out of your way with a visually attractive appearance.
          </Subline>
        </Text>
        <Visualization>
          <Video

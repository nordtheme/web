...
/**
 * The component that represents the hero section for the landing page of the "Nord Terminator" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-terminator");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Terminator.
        </P>
      </Content>
      <WaveFooter />
    </Section>

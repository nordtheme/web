...
/**
 * The component that represents the hero section for the landing page of the "Nord gedit" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-gedit");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord gedit.
        </P>
      </Content>
      <WaveFooter />
    </Section>

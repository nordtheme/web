...
/**
 * The component that represents the hero section for the landing page of the "Nord Termite" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-termite");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Termite.
        </P>
      </Content>
      <WaveFooter />
    </Section>

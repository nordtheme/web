...
/**
 * The component that represents the hero section for the landing page of the "Nord GNOME Terminal" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-gnome-terminal");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord GNOME Terminal.
        </P>
      </Content>
      <WaveFooter />
    </Section>

...
/**
 * The component that represents the UI elements section for the landing page of the "Nord Visual Studio Code" port project.
 * @since 0.15.0
 */
  ...
  <Section id={SECTION_ID}>
    <Content centered>
      <FeatureDuo columnRatio={[1, 2]}>
        ...
        <Visualization>
          <Image alt="Screenshot showing UI elements for the debug view" dropShadow fluid={assets.images["ui-debug.png"]} rounded>
            <span>
      ...
      <FeatureDuo columnRatio={[2, 1]}>
        ...
        <Text>
          <Subline>
            Sane styles for basic <Link href="https://code.visualstudio.com/docs/getstarted/userinterface">workbench UI elements</Link> like the tree view of

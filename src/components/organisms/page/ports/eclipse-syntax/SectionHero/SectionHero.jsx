...
/**
 * The component that represents the hero section for the landing page of the "Nord Eclipse Syntax" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-eclipse-syntax");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Eclipse Syntax.
        </P>
      </Content>
      <WaveFooter />
    </Section>

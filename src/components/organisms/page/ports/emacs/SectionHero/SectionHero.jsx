...
const SectionHero = ({ assets }) => {
  ...
  const { gitHubRepositoryUrl, projectUrl } = portMetadata.find((port) => port.name === "emacs");
      ...
      <Content centered decorated>
        <FeatureDuo verticalOnly>
          <Text verticalOnly>
            ...
            <Subline>
              Build for Emacs&apos;s terminal- and GUI mode with <em>true colors</em> and support for many third-party syntax and UI plugins.
            </Subline>
            <Actions>

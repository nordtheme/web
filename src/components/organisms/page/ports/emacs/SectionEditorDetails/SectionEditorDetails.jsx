...
const SECTION_ID = sectionIdFor(ROUTE_PORTS_EMACS, 3);

/**
 * The component that represents the editor details section for the landing page of the "Nord Emacs" port project.
 * @since 0.17.0
 */

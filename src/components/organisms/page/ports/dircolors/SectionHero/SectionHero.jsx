...
import { ROUTE_DOCS_PORTS_DIRCOLORS, ROUTE_DOCS_PORTS_DIRCOLORS_INSTALLATION, ROUTE_PORTS_DIRCOLORS } from "config/routes/mappings";
...
const SectionHero = ({ assets }) => {
  ...
  const { gitHubRepositoryUrl, projectUrl } = portMetadata.find((port) => port.name === "dircolors");

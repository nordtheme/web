...
/**
 * The component that represents the hero section for the landing page of the "Nord Xfce Terminal" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-xfce-terminal");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Xfce Terminal.
        </P>
      </Content>
      <WaveFooter />
    </Section>

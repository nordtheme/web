...
/**
 * The component that represents the hero section for the landing page of the "Nord Terminal.app" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-terminal-app");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Terminal.app.
        </P>
      </Content>
      <WaveFooter />
    </Section>

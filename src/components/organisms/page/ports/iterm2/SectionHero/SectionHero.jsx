...
/**
 * The component that represents the hero section for the landing page of the "Nord iTerm2" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-iterm2");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord iTerm2.
        </P>
      </Content>
      <WaveFooter />
    </Section>

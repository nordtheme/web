...
/**
 * The component that represents the hero section for the landing page of the "Nord Hyper" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-hyper");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Hyper.
        </P>
      </Content>
      <WaveFooter />
    </Section>

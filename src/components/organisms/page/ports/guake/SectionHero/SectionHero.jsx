...
/**
 * The component that represents the hero section for the landing page of the "Nord Guake" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-guake");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Guake.
        </P>
      </Content>
      <WaveFooter />
    </Section>

...
/**
 * The component that represents the hero section for the landing page of the "Nord Mintty" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-mintty");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Mintty.
        </P>
      </Content>
      <WaveFooter />
    </Section>

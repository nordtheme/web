...
/**
 * The component that represents the hero section for the landing page of the "Nord Tilix" port project.
 *
...
export default function SectionHero() {
  ...
  const { gitHubRepositoryUrl } = portMetadata.find(port => port.name === "nord-tilix");
    ...
    <Section>
      <Content centered>
        ...
        >
          ...
          for information about Nord Tilix.
        </P>
      </Content>
      <WaveFooter />
    </Section>

...
/**
 * The styled header with a fixed position and flexible height for the pinned(collapsed) and unpinned (expanded) header modes.
 * @since 0.3.0
 */
const Header = styled.header`
  ...
  transition: height ${motion.speed.duration.transition.area.medium}ms ease-in-out, box-shadow ${motion.speed.duration.transition.area.medium}ms ease-in-out,

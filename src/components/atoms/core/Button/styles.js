...
const borderColor = themedModeVariant({
  primary: {
    [MODE_BRIGHT_SNOW_FLURRY]: ({ ghost, quiet }) => (ghost && !quiet ? colors.nord8 : colors.font.base[MODE_BRIGHT_SNOW_FLURRY]),
    [MODE_DARK_NIGHT_FROST]: ({ ghost, quiet }) => (ghost && !quiet ? colors.nord8 : colors.font.base[MODE_BRIGHT_SNOW_FLURRY]),
  },
  secondary: {
    [MODE_BRIGHT_SNOW_FLURRY]: ({ ghost, quiet }) => (ghost && !quiet ? colors.nord9 : colors.font.base[MODE_BRIGHT_SNOW_FLURRY]),
    [MODE_DARK_NIGHT_FROST]: ({ ghost, quiet }) => (ghost && !quiet ? colors.nord9 : colors.font.base[MODE_BRIGHT_SNOW_FLURRY]),
  },
  simple: {
...
const borderColorDisabled = themedModeVariant({
  primary: {
    [MODE_BRIGHT_SNOW_FLURRY]: ({ ghost, quiet }) => (ghost && !quiet ? rgba(colors.nord8, 0.6) : rgba(colors.font.base[MODE_BRIGHT_SNOW_FLURRY], 0.4)),
    [MODE_DARK_NIGHT_FROST]: ({ ghost, quiet }) => (ghost && !quiet ? rgba(colors.nord8, 0.6) : rgba(colors.font.base[MODE_BRIGHT_SNOW_FLURRY], 0.75)),
  },
  secondary: {
    [MODE_BRIGHT_SNOW_FLURRY]: ({ ghost, quiet }) => (ghost && !quiet ? rgba(colors.nord9, 0.6) : rgba(colors.font.base[MODE_BRIGHT_SNOW_FLURRY], 0.4)),
    [MODE_DARK_NIGHT_FROST]: ({ ghost, quiet }) => (ghost && !quiet ? rgba(colors.nord9, 0.65) : rgba(colors.font.base[MODE_BRIGHT_SNOW_FLURRY], 0.75)),
  },
  simple: {
...
const borderColorHover = themedModeVariant({
  primary: {
    ...
    [MODE_DARK_NIGHT_FROST]: ({ ghost }) => (ghost ? darken(0.04, colors.nord8) : lighten(0.045, colors.font.base[MODE_BRIGHT_SNOW_FLURRY])),
  },
  secondary: {
    [MODE_BRIGHT_SNOW_FLURRY]: ({ ghost }) => (ghost ? darken(0.04, colors.nord9) : rgba(colors.nord0, 0.8)),
    [MODE_DARK_NIGHT_FROST]: ({ ghost }) => (ghost ? darken(0.04, colors.nord9) : rgba(colors.font.base[MODE_BRIGHT_SNOW_FLURRY], 0.75)),
  },
  simple: {
...
const fontColorActive = themedModeVariant({
  ...
  subtle: {
    ...
    [MODE_DARK_NIGHT_FROST]: ({ quiet }) => (quiet ? lighten(0.1, colors.font.base[MODE_DARK_NIGHT_FROST]) : darken(0.08, colors.nord8)),
  },
});
...
const fontColorDisabled = themedModeVariant({
  primary: {
    [MODE_BRIGHT_SNOW_FLURRY]: ({ ghost, quiet }) => (ghost && !quiet ? rgba(colors.nord8, 0.6) : rgba(colors.font.base[MODE_BRIGHT_SNOW_FLURRY], 0.4)),
    [MODE_DARK_NIGHT_FROST]: ({ ghost, quiet }) => (ghost && !quiet ? rgba(colors.nord8, 0.6) : rgba(colors.font.base[MODE_BRIGHT_SNOW_FLURRY], 0.8)),
  },
  secondary: {
    [MODE_BRIGHT_SNOW_FLURRY]: ({ ghost, quiet }) => (ghost && !quiet ? rgba(colors.nord9, 0.6) : rgba(colors.font.base[MODE_BRIGHT_SNOW_FLURRY], 0.4)),
    [MODE_DARK_NIGHT_FROST]: ({ ghost, quiet }) => (ghost && !quiet ? rgba(colors.nord9, 0.65) : rgba(colors.font.base[MODE_BRIGHT_SNOW_FLURRY], 0.8)),
  },
  simple: {
    [MODE_BRIGHT_SNOW_FLURRY]: rgba(colors.font.base[MODE_BRIGHT_SNOW_FLURRY], 0.4),
...
const fontColorHover = themedModeVariant({
  ...
  subtle: {
    [MODE_BRIGHT_SNOW_FLURRY]: ({ quiet }) => (quiet ? darken(0.05, colors.font.base[MODE_BRIGHT_SNOW_FLURRY]) : darken(0.05, colors.nord10)),
    [MODE_DARK_NIGHT_FROST]: ({ quiet }) => (quiet ? lighten(0.05, colors.font.base[MODE_DARK_NIGHT_FROST]) : darken(0.04, colors.nord8)),
  },
});
...
const styles = css`
  ...
  transition: background-color ${motion.speed.duration.transition.text.fade}ms ease-in, border-color ${motion.speed.duration.transition.text.fade}ms ease-in,
    box-shadow ${motion.speed.duration.transition.text.fade}ms ease-in, color ${motion.speed.duration.transition.text.fade}ms ease-in;
  ${({ outlined }) =>
    outlined &&
    css`

...
const Tmux = ({ fillColors, svgRef, ...passProps }) => (
  <svg {...passProps} ref={svgRef} viewBox="0 0 46 46" xmlns="http://www.w3.org/2000/svg">
    <path d="M0 2.557v40.887A2.558 2.558 0 0 0 2.557 46h18.987V0H2.557A2.557 2.557 0 0 0 0 2.557z" fill={fillColors.tileLeft} />
    ...
    <path d="M2.557 46h40.887A2.558 2.558 0 0 0 46 43.443v-1.482H0v1.482A2.559 2.559 0 0 0 2.557 46z" fill={fillColors.statusBar} />
  </svg>
);

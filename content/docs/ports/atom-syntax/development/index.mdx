...
```sh
git clone https://github.com/nordtheme/atom-syntax.git
```
...
<Button href="https://github.com/nordtheme/atom-syntax/archive/develop.zip">Download</Button>
...
[gh-repo]: https://github.com/nordtheme/atom-syntax

...
export const frontmatter = {
  title: "Type Support",
  subline: "Learn about the wide range of supported data and node types — From symbolic links, executables up to file system permissions.",
};
...
<Image alt="Screenshot showing an overview of various file and node types colorized by Nord" dropShadow fluid={props.images["overview.png"]} rounded>
...
<Image alt="Screenshot showing directories with different file system permissions" dropShadow fluid={props.images["permissions.png"]} rounded>
  <span>
...
<Image alt="Screenshot showing various Unix file types" dropShadow fluid={props.images["blocks-and-sockets.png"]} rounded>
...
<Image alt="Screenshot showing files with different capabilities" dropShadow fluid={props.images["capabilities.png"]} rounded>
...
<Image alt="Screenshot showing a named pipe also know as FIFO" dropShadow fluid={props.images["named_pipes.png"]} rounded>
...
<Image alt="Screenshot showing file extensions for multimedia files" dropShadow fluid={props.images["extension-pattern-media.png"]} rounded>
...
<Image alt="Screenshot showing ignore pattern files" dropShadow fluid={props.images["extension-pattern-ignore.png"]} rounded>

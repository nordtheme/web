...
<Image dropShadow fluid={props.images["shell-rc.png"]} rounded alt="Screenshot showing an example of a shell configuration file to load Nord through dircolors">
  <span>

...
It's <Link to={ROUTE_DOCS_COLOR_AND_PALETTES}>colors and palettes</Link> have especially been designed for UI elements and code syntax highlighting often found in projects build with web technologies like websites.
